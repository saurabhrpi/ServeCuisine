 ...
 */
 ...
 public class FoodFactory{          
     ...
     //String[] cuisines = {"Chinese","Italian","Japanese","Mexican"};
     Map<String,Cuisine> map;
     public FoodFactory()
     {
         map = new HashMap<>();
     }
     ...
     public Cuisine serveCuisine(String cuisineKey, String dish) throws UnservableCuisineRequestException
     {
         if(map.containsKey(cuisineKey))
         {
            map.get(cuisineKey).serveFood(dish);
            return map.get(cuisineKey);
         }
         throw new UnservableCuisineRequestException("exception");   
     }
 } 
